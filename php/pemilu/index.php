...
<head>
        ...
        <title>Hitung Cepat Real Count Pemilu 2019</title>
    ...
    <body>
      <?php include "getData.php"; ?>
        <header id="header">
          <div class="container"><h1 style="text-align: center; color: white;"> HASIL HITUNG CEPAT SUARA SAH PEMILU 2019 </h1></div>
        </header>
        <section id="main">
            <section id="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="epc-item bgm-cyan">
                              ...
                              $persenDua = number_format(($hasilSuaraDua['suara_dua']/$hasilTotal*100),2);
                                ...
                                <div  class="row"><h2 style="color: white;">Ir. H. Joko Widodo - Prof. Dr. KH. Ma'ruf Amin</h2></div>
                        ...
                        <div class="col-sm-6">
                            <div class="epc-item bgm-orange">
                                ...
                                <div  class="row"><h2 style="color: white;">H. Prabowo Subianto - H. Sandiaga Salahudin Uno</h2></div>
                                <div class="pie-title" style="color: white;">Jumlah Suara</div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                      <h3>Jumlah TPS Masuk : <?php echo $jumlahTPSMasuk;?> dari 2841 </h3>
                     </div>
                     <!-- Jam -->
