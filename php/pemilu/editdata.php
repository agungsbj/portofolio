...
<fieldset>
  ...
  <div class="row">
    <div class="col offset-s1">
      <a href="editdata.php" class="waves-effect waves-light btn-large"><i class="material-icons right">cached</i>REFRESH TABEL</a>
    </div>
  </div>
  ...
  global $link;
   ...
   ?>
            <tr>
                ...
                <a href="editdata.php?edit=<?php echo $data['id'];?>" type="submit"  class="btn waves-light waves-effect"><i class="material-icons right">create</i></a>
              </form>
                </td>
          ...
          <div class="row">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <div class="input-field">
                  <input placeholder="Suara Paslon Nomor 1" value="<?php if(isset($_GET['edit'])) echo $dataEdit['paslon_satu'];?>" id="JA" type="number" min="0" name="JA" class="validate" required>
                 </div>
                </td>
                <td>
                  <div class="input-field">
                  <input placeholder="Suara Paslon Nomor 2" value="<?php if(isset($_GET['edit'])) echo $dataEdit['paslon_dua'];?>" id="PS" name="PS" type="number" min="0" class="validate" required>
                </div>
                </td>
              </tr>
            </tbody>
