...
<div class="container">
    <div class="row">
      ...
      <thead>
        <tr>
            <th><center>JOKOWI - AMIN</center></th>
            <th><center>PRABOWO - SANDIAGA</center></th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td>
            <div class="input-field col s12">
            <input placeholder="Suara Paslon Nomor 1" id="JA" type="number" min="0" name="JA" class="validate" required>
           </div>
          </td>
          <td>
            <div class="input-field col s12">
            <input placeholder="Suara Paslon Nomor 2" id="PS" name="PS" type="number" min="0" class="validate" required>
          </div>
          </td>
        </tr>
      </tbody>
  ...
  <div class="row">
    ...
    <button class="waves-effect waves-light centered btn-large" type="submit" name="submit">Simpan Data <i class="material-icons right">save</i>
      ...
      <div class=" col s6 text-lighten-5">
          <h5>Jumlah TPS Disimpan : <?php echo $jumlahTPSMasuk;?> dari 2841</h5>
      </div>
  </div>
</div>
</form>
