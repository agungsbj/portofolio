...
Public Class Sertifikat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fajar_Utama.Sertifikat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nis1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nis2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSertifikat
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sertifikat = New Sertifikat()
        rpt.Site = Me.Site
        Return rpt
    End Function
