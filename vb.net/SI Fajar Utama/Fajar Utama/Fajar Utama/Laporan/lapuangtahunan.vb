...
Public Class lapuangtahunan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fajar_Utama.lapuangtahunan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlapuangtahunan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapuangtahunan = New lapuangtahunan()
        rpt.Site = Me.Site
        Return rpt
    End Function
