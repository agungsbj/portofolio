...
Public Class lapdaftartahun
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Fajar_Utama.lapdaftartahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlapdaftartahun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapdaftartahun = New lapdaftartahun()
        rpt.Site = Me.Site
        Return rpt
    End Function
