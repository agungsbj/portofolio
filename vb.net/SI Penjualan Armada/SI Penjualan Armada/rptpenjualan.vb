...
Public Class rptpenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_Penjualan_Armada.rptpenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpenjualan = New rptpenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
