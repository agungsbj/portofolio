...
Public Class rptpenjualannama
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.rptpenjualannama.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpenjualannama
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpenjualannama = New rptpenjualannama()
        rpt.Site = Me.Site
        Return rpt
    End Function
