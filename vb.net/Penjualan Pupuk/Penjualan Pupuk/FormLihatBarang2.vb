...
Public Class FormLihatBarang2
    Private Sub FormLihatBarang2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call koneksi()
        TextBox1.Clear()
        TextBox1.Focus()
        listdata()
    ...
    Public Sub listdata()
        ...
        aksi = "select * from barang where nama like '%" & Trim(TextBox1.Text) & "%' and supplier like '%" & Trim(FormPembelian.ComboBox1.Text) & "%' order by idbrg asc"
        ...
        Try
            While dreader.Read
                ...
                With ListView1
                    ...
                    ListView1.Items(x).SubItems(6).Text = dreader.GetString(7)
                End With
            End While
        Finally
            dreader.Close()
    ...
    Private Sub pilih()
        Try
            FormPembelian.txtkdbrg.Text = ListView1.SelectedItems(0).SubItems(0).Text.ToString
